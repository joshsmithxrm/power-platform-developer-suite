...
namespace PPDS.Cli.Services.Solutions;
...
public class SolutionService : ISolutionService
{
    ...
    /// <param name="guard">The shakedown guard.</param>
    ...
    public async Task<Guid> ImportAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _guard.EnsureCanMutate("solutions.import");
    ...
    {
        _guard.EnsureCanMutate("solutions.publishAll");
