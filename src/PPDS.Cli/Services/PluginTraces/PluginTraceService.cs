...
namespace PPDS.Cli.Services.PluginTraces;
...
public class PluginTraceService : IPluginTraceService
{
    ...
    /// <param name="guard">The shakedown guard gating mutations.</param>
    ...
    public async Task<int> DeleteByIdsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _guard.EnsureCanMutate("plugintraces.deleteByIds");
    ...
    public async Task<int> DeleteByFilterAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _guard.EnsureCanMutate("plugintraces.deleteByFilter");
    ...
    public async Task<int> DeleteAllAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _guard.EnsureCanMutate("plugintraces.deleteAll");
    ...
    public async Task SetSettingsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _guard.EnsureCanMutate("plugintraces.setSettings");
