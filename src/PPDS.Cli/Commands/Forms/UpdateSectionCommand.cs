...
/// </summary>
public static class UpdateSectionCommand
{
    public static Command Create()
    {
        ...
        {
            Description = "Section current label",
            Required = true
        };

        var labelOption = new Option<string?>("--label")
        {
            Description = "New label for the section (renames the section)"
        };
        ...
        {
            Description = "Publish customizations after updating the section",
        ...
        var command = new Command("update-section", "Update properties of an existing section on a Main form")
        {
            entityOption,
            formOption,
            sectionOption,
        ...
        CancellationToken ct)
    {
        ...
        try
        {
            ...
            await formService.UpdateSectionAsync(request, null, ct);

            if (globalOptions.IsJsonMode)
            {
                writer.WriteSuccess(new UpdateSectionResult
                {
                    Section = section,
            ...
            {
                Console.Error.WriteLine($"Section '{section}' updated.");
            }
        ...
        {
            var error = ExceptionMapper.Map(ex, context: "updating section", debug: globalOptions.Debug);
    ...
    private sealed class UpdateSectionResult
    {
