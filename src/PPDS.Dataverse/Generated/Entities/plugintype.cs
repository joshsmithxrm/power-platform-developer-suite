...
namespace PPDS.Dataverse.Generated
{
	...
	public partial class PluginType : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<PPDS.Dataverse.Generated.SdkMessageProcessingStep> plugintype_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PPDS.Dataverse.Generated.SdkMessageProcessingStep>("plugintype_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("plugintype_sdkmessageprocessingstep");
				this.SetRelatedEntities<PPDS.Dataverse.Generated.SdkMessageProcessingStep>("plugintype_sdkmessageprocessingstep", null, value);
		...
		public System.Collections.Generic.IEnumerable<PPDS.Dataverse.Generated.SdkMessageProcessingStep> plugintypeid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PPDS.Dataverse.Generated.SdkMessageProcessingStep>("plugintypeid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("plugintypeid_sdkmessageprocessingstep");
				this.SetRelatedEntities<PPDS.Dataverse.Generated.SdkMessageProcessingStep>("plugintypeid_sdkmessageprocessingstep", null, value);
		...
		public PPDS.Dataverse.Generated.SystemUser createdby_plugintype
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.SystemUser>("createdby_plugintype", null);
			}
		}
		...
		public PPDS.Dataverse.Generated.SystemUser lk_plugintype_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.SystemUser>("lk_plugintype_createdonbehalfby", null);
			}
		}
		...
		public PPDS.Dataverse.Generated.SystemUser lk_plugintype_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.SystemUser>("lk_plugintype_modifiedonbehalfby", null);
			}
		}
		...
		public PPDS.Dataverse.Generated.SystemUser modifiedby_plugintype
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.SystemUser>("modifiedby_plugintype", null);
			}
		}
		...
		public PPDS.Dataverse.Generated.PluginAssembly pluginassembly_plugintype
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.PluginAssembly>("pluginassembly_plugintype", null);
			}
			set
			{
				this.OnPropertyChanging("pluginassembly_plugintype");
				this.SetRelatedEntity<PPDS.Dataverse.Generated.PluginAssembly>("pluginassembly_plugintype", null, value);
