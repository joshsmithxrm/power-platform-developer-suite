...
/// </summary>
/// <remarks>
/// Adapted from PPDS.Cli.Infrastructure.DaemonConnectionPoolManager.
/// Uses Lazy&lt;Task&lt;T&gt;&gt; pattern to prevent duplicate creation races.
/// </remarks>
public sealed class McpConnectionPoolManager : IMcpConnectionPoolManager
{
    /// <summary>
        ...
        ISecureCredentialStore credentialStore)
    {
        ...
        // Configure minimal logging for MCP server.
