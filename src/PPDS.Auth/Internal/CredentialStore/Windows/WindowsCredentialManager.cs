...
using System.Text;
using PPDS.Auth.Internal.CredentialStore.Windows.Native;

namespace PPDS.Auth.Internal.CredentialStore.Windows
{
    internal class WindowsCredentialManager : ICredentialStore
    {
        ...
        {
            string password = credential.GetCredentialBlobAsString() ?? string.Empty;
