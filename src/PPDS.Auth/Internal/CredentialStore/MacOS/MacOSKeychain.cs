...
using System.Text;
using PPDS.Auth.Internal.CredentialStore.MacOS.Native;
using static PPDS.Auth.Internal.CredentialStore.MacOS.Native.CoreFoundation;
using static PPDS.Auth.Internal.CredentialStore.MacOS.Native.SecurityFramework;

namespace PPDS.Auth.Internal.CredentialStore.MacOS
{
    internal class MacOSKeychain : ICredentialStore
    {
        ...
        {
            string service = GetStringAttribute(attributes, kSecAttrService) ?? string.Empty;
            string account = GetStringAttribute(attributes, kSecAttrAccount) ?? string.Empty;
            string password = GetStringAttribute(attributes, kSecValueData) ?? string.Empty;
            string label = GetStringAttribute(attributes, kSecAttrLabel) ?? string.Empty;
