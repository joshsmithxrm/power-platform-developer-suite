...
// Modifications: namespace renamed to PPDS.Auth.Internal.CredentialStore.Linux;
...
using System.Text;
using static PPDS.Auth.Internal.CredentialStore.Linux.Native.Gobject;
using static PPDS.Auth.Internal.CredentialStore.Linux.Native.Glib;
using static PPDS.Auth.Internal.CredentialStore.Linux.Native.Libsecret;
using static PPDS.Auth.Internal.CredentialStore.Linux.Native.Libsecret.SecretSchemaAttributeType;
using static PPDS.Auth.Internal.CredentialStore.Linux.Native.Libsecret.SecretSchemaFlags;

namespace PPDS.Auth.Internal.CredentialStore.Linux
{
    internal class SecretServiceCollection : ICredentialStore
    {
        ...
        private static unsafe ICredential CreateCredentialFromItem(SecretItem* item)
        {
            ...
            try
            {
                ...
                string service = Marshal.PtrToStringAuto(serviceValuePtr) ?? string.Empty;
                ...
                string account = Marshal.PtrToStringAuto(accountValuePtr) ?? string.Empty;
                ...
                string password = Marshal.PtrToStringAuto(passwordPtr, passwordLength) ?? string.Empty;
