...
/// <summary>
/// Unit tests for <see cref="EnvironmentVariablesSetTool"/>.
/// </summary>
[Trait("Category", "Unit")]
public sealed class EnvironmentVariablesSetToolTests
{
    ...
    {
        // Act
        var act = () => new EnvironmentVariablesSetTool(null!);
    ...
    public async Task ExecuteAsync_NullSchemaName_ThrowsArgumentException()
    {
        ...
        var tool = new EnvironmentVariablesSetTool(context);

        // Act
        Func<Task> act = () => tool.ExecuteAsync(null!, "some-value");
    ...
    public async Task ExecuteAsync_EmptySchemaName_ThrowsArgumentException()
    {
        ...
        // Act
        Func<Task> act = () => tool.ExecuteAsync("", "some-value");
