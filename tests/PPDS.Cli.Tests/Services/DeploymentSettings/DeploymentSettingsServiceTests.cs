...
namespace PPDS.Cli.Tests.Services.DeploymentSettings;
...
public class DeploymentSettingsServiceTests
{
    ...
    [Fact]
    public void AddCliApplicationServices_RegistersIDeploymentSettingsService()
    {
        // Arrange
    ...
    [Fact]
    public void AddCliApplicationServices_DeploymentSettingsServiceIsTransient()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddLogging();
