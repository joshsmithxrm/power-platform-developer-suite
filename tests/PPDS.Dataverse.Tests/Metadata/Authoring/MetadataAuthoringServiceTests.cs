...
public class MetadataAuthoringServiceTests
{
    ...
    {
        var act = () => new DataverseMetadataAuthoringService(null!, _validator);
    ...
    {
        var act = () => new DataverseMetadataAuthoringService(_pool.Object, null!);
    ...
    [Fact]
    public void RegisterDataverseServices_RegistersAuthoringService()
    {
