...
| 1.5 | Metadata Service | complete | reviewed | [05-metadata-service.md](01-dataverse/05-metadata-service.md) |
| 1.6 | Query Executor | complete | reviewed | [06-query-executor.md](01-dataverse/06-query-executor.md) |
...
| 3.2 | Export Pipeline | complete | reviewed | [02-export-pipeline.md](03-migration/02-export-pipeline.md) |
...
| 4.2 | Connection Service | complete | reviewed | [02-connection-service.md](04-cli-services/02-connection-service.md) |
| 4.3 | Export Service | complete | reviewed | [03-export-service.md](04-cli-services/03-export-service.md) |
...
| 5.3 | Dialogs | complete | reviewed | [03-dialogs.md](05-tui/03-dialogs.md) |
...
| 6.2 | Tools | complete | reviewed | [02-tools.md](06-mcp/02-tools.md) |

### 7. VS Code Extension

| # | Subsystem | Status | Review Status | Spec File |
|---|-----------|--------|---------------|-----------|
| 7.1 | Architecture | complete | reviewed | [01-architecture.md](07-vscode/01-architecture.md) |
| 7.2 | Features | complete | reviewed | [02-features.md](07-vscode/02-features.md) |
