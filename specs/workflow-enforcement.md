...
| AC-101 | Stop hook reads `phase` from state and skips enforcement for `starting`, `investigating`, `design`, `reviewing`, `pr` phases | `test_pipeline.py::test_stop_hook_phase_bypass` | 🔲 |
