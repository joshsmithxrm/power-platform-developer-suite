...
| **PR-2b** | New hook files: monitor-gate + pr-invocation-gate (merged into session-stop-workflow.py steps 5b/5c), skill-line-cap.py, retro-html-guard.py, worktree-safety.py, debug-first.py. Wire all into .claude/settings.json. Code only. | AC-147 through AC-151, AC-157, AC-158, AC-163, AC-164, AC-169 through AC-171, AC-175 | M (~400 LOC, 5 hooks) | PR-2a (markers identify targets) |
