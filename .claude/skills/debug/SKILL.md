...
**For AI self-verification:** Use `/verify extension` to exercise commands, inspect state, and verify webview rendering. See the CDP tool reference in `/verify` `REFERENCE.md Â§ext`.
